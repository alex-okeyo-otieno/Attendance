...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] branchString = new String[] { "IT","COM","MATHS","KISWAHILI"};
	private String[] yearString = new String[] {"YEAR 1","YEAR 2","YEAR 3","YEAR 4"};
	private String[] subjectSEString = new String[] {"BIT 111","BIT 112"};
	private String[] subjectTEString = new String[] {"BIT 211","BIT 212"};
	private String[] subjectBEString = new String[] {"BIT 311","BIT 312"};

	private String[] subjectFinal = new String[] {"OFFICE AUTOMATION","SYSTEM ADMINISTRATION","DATABASE ADMINISTRATION","SYSTEM DESIGN","DATA ANALYSIS","PROJECT MANAGEMENT"};
